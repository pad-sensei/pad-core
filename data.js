...
// **表記は #11 に統一する**。うりなみさん 2026-07-26:
//   「説明としては、5度がないでいいの。みんな間違えるのはそれだからね。でも、
//     テンションとしては全部オルタードして認識するから#11とするのは矛盾しないし、
//     認知負荷を減らすの」
// つまり「5度が無い」は教える時の説明、#11 は表記。両立する。
//
...
const SCALE_FULL_NAMES = {
  ...
  20: '7(b13, #11, #9, b9)',       // Super Locrian (Altered)
